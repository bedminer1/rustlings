...
mod tests {
    ...
    fn reference_no_mutation() {
        ...
        assert!(matches!(input, Cow::Borrowed(_))); // if there is a mutation, transfer ownership
    }
    ...
    fn owned_no_mutation() {
        ...
        abs_all(&mut input);
        // TODO: Replace `todo!()` with `Cow::Owned(_)` or `Cow::Borrowed(_)`.
        assert!(matches!(input, Cow::Owned(_))); // explicit transfer ownership without mutation
    }
